<div>
    <div class="container mx-auto text-center mt-10">
        <div class="mx-auto">
            <h1 class="text-4xl">
                Команда - <span class="text-green-600">Введите текст...</span>
            </h1>
        </div>
        ...
        <div class="grid grid-cols-3 gap-10 mt-20 max-[1050px]:grid-cols-1 max-[375px]:p-10">
            <div class="max-[1050px]:mx-auto">
                ...
                <div class="mx-auto text-left mt-2">
                    <p class="font-bold">Матвей - php-разработчик</p>

                    <div>
                        <p>разработка backenda приложения</p>
                    </div>
                </div>
            </div>
            <div class="max-[1050px]:mx-auto">
                ...
                <div class="mx-auto text-left mt-2">
                    <p class="font-bold">Роман - php-разработчик</p>

                    <div>
                        <p>разработка настроения</p>
                    </div>
                </div>
            </div>
            <div class="max-[1050px]:mx-auto">
                ...
                <div class="mx-auto text-left mt-2">
                    <p class="font-bold">Денис - php-разработчик</p>

                    <div>
                        <p>разработка UI/UX</p>
                    </div>
                </div>
            </div>
            <div class="min-[1050px]:col-span-2 max-[1050px]:mx-auto">
                ...
                <div class="mx-auto text-left mt-2">
                    <p class="font-bold">Татьяна - Менеджер команды</p>
            ...
            <div class="max-[1050px]:mx-auto">
                ...
                <div class="mx-auto text-left mt-2">
                    <p class="font-bold">Ульяна - аналитик</p>

                    <div>
                        <p>разработка машинного обучения</p>
                    </div>
                </div>
            </div>
        </div>
